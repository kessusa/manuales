...
{# Tooltip custom con CSS puro — funciona dentro de modales sin depender de Bootstrap Popover #}
<style>
  .waf-tip { position: relative; display: inline-block; cursor: help; }
  .waf-tip .waf-tip-body {
      position: absolute;
      bottom: 125%;
      left: 50%;
  ...
  .waf-tip:hover .waf-tip-body,
  .waf-tip:focus .waf-tip-body,
  .waf-tip:focus-within .waf-tip-body { opacity: 1; visibility: visible; }
  .waf-tip .waf-tip-body p { margin: 0; padding: 0; line-height: 1.45; }
  .waf-tip .waf-tip-body p + p { margin-top: .15rem; }
</style>
    ...
    <div class="modal-body"
        ...
        <div style="border:1px solid var(--bs-border-color); border-radius:.5rem;
            ...
            <label style="font-size:.75rem; font-weight:700; text-transform:uppercase;
                ...
                <span class="waf-tip text-secondary ms-1" tabindex="0">
                    <i class="far fa-question-circle"></i>
                    <span class="waf-tip-body">
                        <p><span class="text-primary fw-bold">PRE-CRS:</span> Custom rules</p>
                        <p><span class="text-primary fw-bold">CRS:</span> Core Rule Set</p>
                    </span>
                </span>
            </label>
        ...
        <div style="border:1px solid var(--bs-border-color); border-radius:.5rem;
            ...
            <label style="font-size:.75rem; font-weight:700; text-transform:uppercase;
                ...
                <span class="waf-tip text-secondary ms-1" tabindex="0">
                    <i class="far fa-question-circle"></i>
                    <span class="waf-tip-body">
                        <p><span class="text-primary fw-bold">Add Rule:</span> New rule</p>
                        <p><span class="text-primary fw-bold">Add Exclusion:</span> Exclusion</p>
                        <p><span class="text-primary fw-bold">Enable/Disable:</span> Activate/deactivate</p>
                    </span>
                </span>
            </label>
            <div class="d-flex flex-wrap gap-3">
        ...
        <div style="border:1px solid var(--bs-border-color); border-radius:.5rem;
            ...
            <label style="font-size:.75rem; font-weight:700; text-transform:uppercase;
                ...
                <span class="waf-tip text-secondary ms-1" tabindex="0">
                    <i class="far fa-question-circle"></i>
                    <span class="waf-tip-body">
                        <p><span class="text-primary fw-bold">Enforcement:</span> Block attacks</p>
                        <p><span class="text-primary fw-bold">Detection:</span> Only log</p>
                    </span>
                </span>
            </label>
            <div class="d-flex flex-wrap gap-3">
        ...
        <div style="border:1px solid var(--bs-border-color); border-radius:.5rem;
            ...
            <label style="font-size:.75rem; font-weight:700; text-transform:uppercase;
                ...
                <span class="waf-tip text-secondary ms-1" tabindex="0">
                    <i class="far fa-question-circle"></i>
                    <span class="waf-tip-body">
                        <p><span class="text-primary fw-bold">Format:</span> JSON</p>
                        <p><span class="text-primary fw-bold">Use for:</span> exclusions or rule definitions</p>
                    </span>
                </span>
            </label>
        ...
        <div style="border:1px solid var(--bs-border-color); border-radius:.5rem;
            ...
            <label style="font-size:.75rem; font-weight:700; text-transform:uppercase;
                ...
                <span class="waf-tip text-secondary ms-1" tabindex="0">
                    <i class="far fa-question-circle"></i>
                    <span class="waf-tip-body">
                        <p><span class="text-primary fw-bold">Selection:</span> one or more</p>
                        <p><span class="text-primary fw-bold">Applies to:</span> chosen WAF policies</p>
                    </span>
                </span>
            </label>
...
(function () {
    ...
    // ---------- Tooltips ----------
    // Los tooltips de ayuda ahora usan .waf-tip (CSS puro, sin JS)
    // Si aún hay data-bs-toggle="tooltip" en algún sitio, los inicializamos:
